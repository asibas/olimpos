...
//		batch.end();
	...
	public void show() {
		...
		motor.agregarFigura(new Figura(Gdx.graphics.getWidth() - 100, 200, TipoFigura.CUADRADO, Color.PINK));
		motor.agregarHueco(new HuecoFigura(50, 200, new Figura(100, 200, TipoFigura.CUADRADO, Color.PINK)));
