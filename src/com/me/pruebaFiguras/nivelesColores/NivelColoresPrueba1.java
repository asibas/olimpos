package com.me.pruebaFiguras.nivelesColores;
...
public class NivelColoresPrueba1 implements Screen {
	...
	public NivelColoresPrueba1(PruebaFiguras juego){
		this.juego = juego;
		motor = new Motor();
	}
	@Override
...
//		batch.end();
	...
	public void show() {
		...
		motor.agregarFigura(new Figura(Gdx.graphics.getWidth() - 100, 100, TipoFigura.CIRCULO, Color.BLUE));
		motor.agregarHueco(new HuecoFigura(50, 100, new Figura(50, 100, TipoFigura.CIRCULO, Color.BLUE)));
		
		motor.agregarFigura(new Figura(Gdx.graphics.getWidth() - 100, 200, TipoFigura.CIRCULO, Color.RED));
		motor.agregarHueco(new HuecoFigura(50, 200, new Figura(100, 200, TipoFigura.CIRCULO, Color.RED)));
